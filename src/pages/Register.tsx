...
export default function Register() {
  ...
  const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      console.log("Making API call to: http://192.168.0.131:9000/student/register");

      const response = await axios.post(
        "http://192.168.0.131:9000/student/register",
        apiData,
        {
          headers: {
  ...
  const handleResendOtp = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://192.168.0.131:9000/student/resend-otp",
        {
          email: formData.email,
